...
export class LocalAuthService {
  ...
  async signupWithUsername(username: string, password: string): Promise<SignupResponse> {
    const existingUser = await this.authService.findByProvider(username, 'local')
    if (existingUser) {
